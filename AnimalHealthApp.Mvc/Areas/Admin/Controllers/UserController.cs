...
namespace AnimalHealthApp.Mvc.Areas.Admin.Controllers
{
    // [Route("api/user")]
    [Area("Admin")]
    // [Authorize(Roles = "Admin")] Tüm actionlara uygular
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Login(UserLoginDto userLoginDto)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    {
                        ModelState.AddModelError("", "E-posta adresiniz veya şifreniz yanlıştır."); // Hackerlar için ucu açık cevap
                        return View("UserLogin");
                    }
                }
                else
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return RedirectToAction("Index", "Home", new { Area = "" }); // Home controller'ın index actionuna gider
        }
